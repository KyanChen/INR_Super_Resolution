...
@register('siren_modulation')
class SirenModulation(nn.Module):
    def __init__(self,
                 num_inner_layers,
                 in_dim,
                 modulation_dim,
        ...
        super(SirenModulation, self).__init__()
        ...
        out_channels_list = torch.cat((out_channels_list, torch.tensor([out_dim])))
        _in_channels = in_dim
        # inner layer
        ...
        print(f'is_shift: {is_shift} is_residual: {is_residual}')
